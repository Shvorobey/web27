<?php $__env->startSection('title', 'Посты автора'); ?>
<?php $__env->startSection('content'); ?>
    <div class="col-md-8">
        <h1 class="my-4" style="color:#0000CD">Все посты автора <u style="color:#006400"><?php echo e($author->name); ?></u> </h1>

    <?php $__currentLoopData = $author->post; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <!-- Blog Post -->
            <div class="card mb-4">
                <img class="card-img-top" src="<?php echo e($post->img); ?>" alt="Card image cap">
                <div class="card-body">
                    <h2 class="card-title" style="color:#ff0000"><?php echo e($post->title); ?></h2>
                ...
                <div class="card-footer text-muted">
                    ...
                    Автор: <?php echo e($post->author->name); ?><br>
                    Категории:
                    <?php $__currentLoopData = $post->categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <br> <a href="<?php echo e($category -> key); ?>"><?php echo e($category->categories); ?>   </a>
